import{t as c,H as n,F as o,L as r,d as m,e as b}from"./loading-Dd-uaQW5.js";function u(a){const d=a||new URLSearchParams(window.location.search).get("id"),l=c.find(s=>s.id===d),i=s=>!s||s.length===0?"":s.map(t=>`
